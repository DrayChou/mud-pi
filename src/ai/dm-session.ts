...
17. 玩家询问“得救了吗、危险解除了吗、游戏结束了吗”时必须亲自依据 committed facts 和 StoryOutcome criteria 回答；成立则同轮提交 outcome，未成立则说明尚存威胁，绝不能回答“当前没有明确目标”
18. 不替玩家决定内心、承诺或重大选择；可以让世界和 NPC 主动回应已发生的事实
