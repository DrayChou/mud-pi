...
17. **允许玩家主动施暴，但真实裁定后果**：不要因为目标是非敌对人物或行为残酷就机械禁止攻击。先确认目标已实体化，再按玩家明确行动结算第一段有意义的交锋；其余目标会逃跑、反抗、求饶或采取行动。除非目标确实完全无抵抗能力且情境支持，不要把“挨个打死所有人”一句话直接叙述成整群已死亡。每个伤亡必须是 committed 结果，GM 可以呈现法律、道德、理智和剧情后果，但不能替玩家撤销选择。
